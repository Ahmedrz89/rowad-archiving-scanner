...
namespace ScannerApplication.Scanner
{
    class WiaScanner
    {
        ...
        public static List<BitmapImage> Scan()
        {
            try
            {
        ...
        /// <returns>Scanned images.</returns>
        public static List<BitmapImage> Scan(string scannerId)
        {
            ...
            while (hasMorePages)
            {
                ...
                try
                {
                    ...
                    foreach (WIA.Property prop in item.Properties)
                    {
                        ...
                        if (prop.PropertyID == 6151)//horizontal extend
                            prop.set_Value(826);

                        if (prop.PropertyID == 6152)//vertical extend
                            prop.set_Value(1169);
                    }
